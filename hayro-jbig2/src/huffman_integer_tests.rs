use super::{
    ...
    huffman_integer_samples::{CASES, INVALID},
};
use alloc::vec::Vec;
...
#[test]
fn huffman_integer_and_prefix_boundaries_preserve_authored_pixels() {
...
#[test]
fn huffman_integer_overflow_and_overfilled_codes_require_errors() {
    let mut context = DecoderContext::default();
    for case in INVALID {
