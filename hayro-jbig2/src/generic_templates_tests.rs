...
use crate::generic_templates_samples::{CASES, EncodedCase, INVALID};
use alloc::vec::Vec;
...
#[test]
fn generic_templates_and_typical_prediction_preserve_authored_pixels() {
...
#[test]
fn generic_templates_invalid_flags_and_adaptive_pixels_require_errors() {
    let mut context = DecoderContext::default();
    for case in INVALID {
